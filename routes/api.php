...
Route::prefix('v1')->middleware(['cors', 'throttle:api'])->group(function () {
    Route::middleware(['auth:api'])->group(function () {
        ...
        Route::post('/comptes/{compteId}/bloquer', [CompteController::class, 'bloquer'])->middleware('logging');
        Route::post('/comptes/{compteId}/debloquer', [CompteController::class, 'debloquer'])->middleware('logging');
